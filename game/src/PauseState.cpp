...
PauseState::PauseState() : State() {
	...
	//Pause Menu: Resume
	go = new GameObject();
	go->AddComponentAsFirst(new Button(*go, ASSETS_PATH("/img/title/button.png"), ASSETS_PATH("/font/VT323.ttf"), "Resume", Vec2(275, 180)));
	...
	go = new GameObject();
	go->AddComponentAsFirst(new Button(*go, ASSETS_PATH("/img/title/button.png"), ASSETS_PATH("/font/VT323.ttf"), "Return to Main Menu", Vec2(275, 220)));
	buttons["main"].emplace_back(AddObject(go, "MAIN"));
	go->box.SetPos(Vec2(-2000, -2000));
	go->Deactivate();
	...
	//Pause Menu: Settings
	go = new GameObject();
	go->AddComponentAsFirst(new Button(*go, ASSETS_PATH("/img/title/button.png"), ASSETS_PATH("/font/VT323.ttf"), "Settings", Vec2(275, 260)));
	buttons["main"].emplace_back(AddObject(go, "MAIN"));
	go->box.SetPos(Vec2(-2000, -2000));
	go->Deactivate();
