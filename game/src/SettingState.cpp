...
SettingState::SettingState() : State() {
	...
	Sprite* selector = new Sprite(*goSelectorF, ASSETS_PATH("/img/Title/SelectorF.png"), 1, 0.01, false, 0.0);
	selector->SetScale(Vec2(3, 3)*GameData::globalScale);
	goSelectorF->AddComponent(selector);

	goSelectorB = new GameObject();
	selector = new Sprite(*goSelectorB, ASSETS_PATH("/img/Title/SelectorB.png"), 1, 0.01, false, 0.0);
	selector->SetScale(Vec2(3, 3)*GameData::globalScale);
	goSelectorB->AddComponent(selector);

	//MenuBook
	goBook = new GameObject();
	book = new Sprite(*goBook, ASSETS_PATH("/img/Title/passando.png"), 6, 0.4, false, 0.0);
	...
	//pageEffectEsq
	go = new GameObject();
	effect = new Sprite(*go, ASSETS_PATH("/img/Title/pageEffectEsq.png"), 4, 0.5, false, 0.0);
	...
	//pageEffectDir
	go = new GameObject();
	effect = new Sprite(*go, ASSETS_PATH("/img/Title/pageEffectDir.png"), 4, 0.5, false, 0.0);
	effect->SetScale(Vec2(4, 4)*GameData::globalScale);
	go->AddComponent(effect);
	...
	go = new GameObject();
	novo = new Sprite(*go, ASSETS_PATH("/img/Title/ScreenButton.png"), 1, 0.1, false, 0.0);
	...
	go = new GameObject();
	novo = new Sprite(*go, ASSETS_PATH("/img/Title/ControllersButton.png"), 1, 0.1, false, 0.0);
	novo->SetScale(Vec2(3, 3)*GameData::globalScale);
	go->AddComponent(novo);
	...
	go = new GameObject();
	novo = new Sprite(*go, ASSETS_PATH("/img/Title/BackButton.png"), 1, 0.1, false, 0.0);
	novo->SetScale(Vec2(3, 3)*GameData::globalScale);
	go->AddComponent(novo);
...
void SettingState::Resume() {
	...
	if(GameData::playerVictory) {
		set->SetTileSet( ASSETS_PATH("/img/tileSet.png") );
	...
	/*	//NPCs
		...
		set->SetTileSet( ASSETS_PATH("/img/bossTileSet.png") );
		...
		if (controllerSelected) {
			...
			if (InputManager::KeyPress(SDLK_KP_ENTER) || InputManager::KeyPress(CONFIRM)) {
				...
				// Check if the event was "Settings".
					...
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 40, "Change Controllers", SDL_Color{ 0,0,0,128 }, Text::SOLID));
					...
					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, "Change UP:", SDL_Color{ 0,0,0,128 }, Text::SOLID));
					settingsMenu->AddComponent(new CameraFollower(*settingsMenu, (Vec2(700, 200)*GameData::globalScale) - (settingsMenu->box.GetSize() / 2)));
					AddObject(settingsMenu, "POSGUI");

					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, SDL_GetKeyName(GameData::UP_MOV), SDL_Color{ 0,0,0,128 }, Text::SOLID));
					...
					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, "Change Down:", SDL_Color{ 0,0,0,128 }, Text::SOLID));
					settingsMenu->AddComponent(new CameraFollower(*settingsMenu, (Vec2(700, 225)*GameData::globalScale) - (settingsMenu->box.GetSize() / 2)));
					AddObject(settingsMenu, "POSGUI");

					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, SDL_GetKeyName(GameData::DOWN_MOV), SDL_Color{ 0,0,0,128 }, Text::SOLID));
					...
					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, "Change Left:", SDL_Color{ 0,0,0,128 }, Text::SOLID));
					settingsMenu->AddComponent(new CameraFollower(*settingsMenu, (Vec2(700, 250)*GameData::globalScale) - (settingsMenu->box.GetSize() / 2)));
					AddObject(settingsMenu, "POSGUI");

					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, SDL_GetKeyName(GameData::LEFT_MOV), SDL_Color{ 0,0,0,128 }, Text::SOLID));
					...
					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, "Change Right:", SDL_Color{ 0,0,0,128 }, Text::SOLID));
					settingsMenu->AddComponent(new CameraFollower(*settingsMenu, (Vec2(700, 275)*GameData::globalScale) - (settingsMenu->box.GetSize() / 2)));
					AddObject(settingsMenu, "POSGUI");

					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, SDL_GetKeyName(GameData::RIGHT_MOV), SDL_Color{ 0,0,0,128 }, Text::SOLID));
					...
					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, "Change Attack 1:", SDL_Color{ 0,0,0,128 }, Text::SOLID));
					settingsMenu->AddComponent(new CameraFollower(*settingsMenu, (Vec2(700, 300)*GameData::globalScale) - (settingsMenu->box.GetSize() / 2)));
					AddObject(settingsMenu, "POSGUI");

					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, SDL_GetKeyName(GameData::MAGIC_BUBBLES), SDL_Color{ 0,0,0,128 }, Text::SOLID));
					...
					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, "Change Attack 2:", SDL_Color{ 0,0,0,128 }, Text::SOLID));
					settingsMenu->AddComponent(new CameraFollower(*settingsMenu, (Vec2(700, 325)*GameData::globalScale) - (settingsMenu->box.GetSize() / 2)));
					AddObject(settingsMenu, "POSGUI");

					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, SDL_GetKeyName(GameData::MAGIC_FIREBALL), SDL_Color{ 0,0,0,128 }, Text::SOLID));
					...
					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, "Change Attack 3:", SDL_Color{ 0,0,0,128 }, Text::SOLID));
					settingsMenu->AddComponent(new CameraFollower(*settingsMenu, (Vec2(700, 350)*GameData::globalScale) - (settingsMenu->box.GetSize() / 2)));
					AddObject(settingsMenu, "POSGUI");

					settingsMenu = new GameObject();
					settingsMenu->AddComponent(new Text(*settingsMenu, ASSETS_PATH("/font/VT323.ttf"), 25, SDL_GetKeyName(GameData::MAGIC_CAPTURE), SDL_Color{ 0,0,0,128 }, Text::SOLID));
					...
					settingsMenu = new GameObject();
					novo = new Sprite(*settingsMenu, ASSETS_PATH("/img/Title/ConfirmButton.png"), 1, 0.1, false, 0.0);
					...
					settingsMenu = new GameObject();
					novo = new Sprite(*settingsMenu, ASSETS_PATH("/img/Title/BackButton.png"), 1, 0.1, false, 0.0);
					novo->SetScale(Vec2(2, 2)*GameData::globalScale);
					settingsMenu->AddComponent(novo);
